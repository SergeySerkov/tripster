...
const style = {
  ...
  inputBox: `h-10 mx-4 border-2 bg-[#eeeeee] flex items-center my-1 py-1 px-2 rounded-lg`,
...
const LocationSelector = () => {
  ...
  const { pickup, setPickup, dropoff, setDropoff } = useContext(TripsterContext);
      ...
      <div className={style.inputBoxes}>
        <div className={`${style.inputBox} ${inFocus === 'from' && style.focusedInputBox}`}>
          ...
          <input
            ...
            placeholder='Start typing with the name of the city'
            value={pickup}
